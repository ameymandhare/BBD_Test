...
public partial class CrimpingStandard
{
    [Key]
    ...
    //[InverseProperty("CrimpingStandard")]
    ...
    //[InverseProperty("CrimpingStandard")]
    //public virtual ICollection<CrimpingStandardDy> CrimpingStandardDies { get; set; } = new List<CrimpingStandardDy>();

    //[InverseProperty("CrimpingStandard")]
    //public virtual ICollection<CrimpingStandardKindDetail> CrimpingStandardKindDetails { get; set; } = new List<CrimpingStandardKindDetail>();

    [ForeignKey("InsulationCrimpShapeId")]
    public virtual MCrimpingShape? InsulationCrimpShape { get; set; }

    //[InverseProperty("CrimpingStandard")]
    //public virtual ICollection<MCrimpingStandardWireInfo> MCrimpingStandardWireInfos { get; set; } = new List<MCrimpingStandardWireInfo>();
